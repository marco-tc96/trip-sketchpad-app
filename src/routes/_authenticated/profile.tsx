...
const CONTINENT_BY_ISO: Record<string, string> = {
  // Europe
  IT: "Europe", FR: "Europe", DE: "Europe", ES: "Europe", PT: "Europe",
  GB: "Europe", NL: "Europe", BE: "Europe", CH: "Europe", AT: "Europe",
  PL: "Europe", SE: "Europe", NO: "Europe", DK: "Europe", FI: "Europe",
  GR: "Europe", CZ: "Europe", HU: "Europe", RO: "Europe", BG: "Europe",
  HR: "Europe", SK: "Europe", SI: "Europe", LT: "Europe", LV: "Europe",
  EE: "Europe", LU: "Europe", MT: "Europe", CY: "Europe", IE: "Europe",
  IS: "Europe", AL: "Europe", RS: "Europe", BA: "Europe", ME: "Europe",
  MK: "Europe", MD: "Europe", BY: "Europe", UA: "Europe", RU: "Europe",
  ...
  TW: "Asia", HK: "Asia", MO: "Asia", TR: "Asia", SA: "Asia",
  AE: "Asia", IL: "Asia", JO: "Asia", LB: "Asia", KW: "Asia",
  QA: "Asia", BH: "Asia", OM: "Asia", IQ: "Asia", IR: "Asia",
  SY: "Asia", YE: "Asia", AF: "Asia", PK: "Asia", BD: "Asia",
  LK: "Asia", NP: "Asia", BT: "Asia", MM: "Asia", KH: "Asia",
  LA: "Asia", MN: "Asia", KZ: "Asia", UZ: "Asia", TM: "Asia",
  TJ: "Asia", KG: "Asia", AZ: "Asia", AM: "Asia", GE: "Asia",
  PS: "Asia", TL: "Asia",
  // Africa
  NG: "Africa", EG: "Africa", ZA: "Africa", KE: "Africa", ET: "Africa",
  GH: "Africa", TZ: "Africa", MA: "Africa", DZ: "Africa", AO: "Africa",
  CM: "Africa", CI: "Africa", SN: "Africa", MG: "Africa", MZ: "Africa",
  ZM: "Africa", ZW: "Africa", TN: "Africa", LY: "Africa", SD: "Africa",
  SS: "Africa", UG: "Africa", CD: "Africa", CG: "Africa", GA: "Africa",
  BF: "Africa", ML: "Africa", NE: "Africa", TD: "Africa", SO: "Africa",
  ER: "Africa", DJ: "Africa", RW: "Africa", BI: "Africa", MW: "Africa",
  NA: "Africa", BW: "Africa", LS: "Africa", SZ: "Africa", MR: "Africa",
  GM: "Africa", GN: "Africa", SL: "Africa", LR: "Africa", GW: "Africa",
  BJ: "Africa", TG: "Africa", GQ: "Africa", CF: "Africa", CV: "Africa",
  ...
  BB: "North America", LC: "North America", VC: "North America",
  ...
  KI: "Oceania", FM: "Oceania", PW: "Oceania", MH: "Oceania",
  NR: "Oceania", TV: "Oceania",
};

const CONTINENT_TRANSLATIONS: Record<string, Record<string, string>> = {
  Europe: {
    it: "Europa", en: "Europe", fr: "Europe", de: "Europa",
    es: "Europa", pt: "Europa", zh: "欧洲", ko: "유럽", ja: "ヨーロッパ",
  },
  Asia: {
    it: "Asia", en: "Asia", fr: "Asie", de: "Asien",
    es: "Asia", pt: "Ásia", zh: "亚洲", ko: "아시아", ja: "アジア",
  },
  Africa: {
    it: "Africa", en: "Africa", fr: "Afrique", de: "Afrika",
    es: "África", pt: "África", zh: "非洲", ko: "아프리카", ja: "アフリカ",
  },
  "North America": {
    it: "America del Nord", en: "North America", fr: "Amérique du Nord",
    de: "Nordamerika", es: "América del Norte", pt: "América do Norte",
    zh: "北美洲", ko: "북아메리카", ja: "北アメリカ",
  },
  "South America": {
    it: "America del Sud", en: "South America", fr: "Amérique du Sud",
    de: "Südamerika", es: "América del Sur", pt: "América do Sul",
    zh: "南美洲", ko: "남아메리카", ja: "南アメリカ",
  },
  Oceania: {
    it: "Oceania", en: "Oceania", fr: "Océanie", de: "Ozeanien",
    es: "Oceanía", pt: "Oceania", zh: "大洋洲", ko: "오세아니아", ja: "オセアニア",
  },
};

function continentNameLocalized(name: string, lang: string): string {
  const base = lang.split("-")[0];
  return CONTINENT_TRANSLATIONS[name]?.[base] ?? name;
}
...
function ProfilePage() {
  ...
  const stats = useMemo(() => {
    ...
    const homeIso = (prof.data as { home_country?: string | null } | undefined)?.home_country
      ?.toUpperCase() ?? null;
    ...
    for (const tr of past) {
      ...
      // Per-trip continent deduplication (a trip spanning FR+DE only counts Europe once)
    ...
    // Home country vs foreign split
    const homeCountryCount = homeIso ? (countryCounts.get(homeIso) ?? 0) : 0;
    const foreignCountriesRanked = countriesRanked.filter((r) => r.iso !== homeIso);
    ...
    <main className="mx-auto max-w-3xl px-4 py-6 sm:py-8">
      ...
      <section className="mt-6">
        ...
        <div className="mt-6 rounded-3xl border border-border bg-card p-5 shadow-soft">
          <h3 className="text-center font-serif text-base font-semibold">
            {t("countries_visited")}
          </h3>
          ...
          <div className="mt-4 space-y-4">
                ...
                rows={[
                  {
                    ...
                    count: stats.homeCountryCount,
                  },
                ]}
              />
            )}

            {/* Foreign countries + cities side by side */}
            <div className="grid gap-4 sm:grid-cols-2">
              {stats.foreignCountriesRanked.length > 0 && (
                <RankList
                  title={
                    homeCountryIso
                      ? t("most_visited_foreign_countries")
                      : t("most_visited_countries")
                  }
                  rows={stats.foreignCountriesRanked.map((r) => ({
                    key: r.iso,
                    left: (
                      <>
                        <span>{flagOf(r.iso)}</span>
                        <span>{countryNameLocalized(r.iso, lang)}</span>
                      </>
                    ),
                    count: r.count,
                  }))}
              ...
              <RankList
                ...
                rows={stats.citiesRanked.map((r) => ({
                  ...
                  left: (
                    <>
                      <span>{flagOf(r.country)}</span>
                      <span>{cityNameLocalized(r.name, lang)}</span>
                    </>
                  ),
                  count: r.count,
                }))}
            ...
            {stats.continentsRanked.length > 0 && (
              <RankList
                ...
                rows={stats.continentsRanked.map((r) => ({
                  key: r.name,
                  left: (
                    <>
                      <span>🌍</span>
                      <span>{continentNameLocalized(r.name, lang)}</span>
                    </>
                  ),
                  count: r.count,
                }))}
                  ...
                  <div key={row.y} className="flex items-center gap-3 text-sm">
                    ...
                    <div className="flex h-3 flex-1 overflow-hidden rounded-full bg-muted">
                      <div
                        ...
                        style={{ width: `${vacPct}%` }}
                        title={`${row.vacation} ${t("vacation")}`}
                      />
                      <div
                        className="h-full bg-slate-600"
                        style={{ width: `${bizPct}%` }}
                        title={`${row.business} ${t("business")}`}
                      />
                      <div
                        className="h-full bg-amber-500"
                        style={{ width: `${dayPct}%` }}
                        title={`${row.daytrip} ${t("daytrip")}`}
                      />
                    </div>
