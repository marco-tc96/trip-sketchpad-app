const translations: Record<string, string> = {
  ...
  nights: "日",
  packing_list: "持ち物リスト",
  add_packing_item: "アイテムを追加…",
  packing_list_empty: "アイテムはまだありません。",
  mark_done: "完了としてマーク",
  trip_type: "旅行タイプ",
  vacation: "休暇",
  business: "出張",
  ...
  dark_mode: "ダーク",
  dock_style: "Dockスタイル",
  dock_style_default: "標準",
  dock_style_liquid: "リキッドグラス",
  layover: "経由",
  layovers: "経由",
  direct: "直行",
  ...
  days_to_end: "あと{{n}}日で終了",
  day_to_end: "あと{{n}}日で終了",
  last_day: "最終日",
  show_pins: "ピン",
  ...
  next_trip: "次の旅行",
  no_upcoming_trips: "予定の旅行なし",
  days_traveled: "旅行日数",
  stats_year: "{{year}}年の統計",
  // ── Farthest-points compass (Profile page) ─────────────────────────────
  extremes_title: "到達した最遠地点",
  northernmost: "最北",
  southernmost: "最南",
  easternmost: "最東",
  westernmost: "最西",
  // ── Transport stats (Profile page) ──────────────────────────────────────
  transport_stats: "交通統計",
  most_used_line: "最も利用した路線",
  most_used_route: "最も利用したルート",
  most_used_station: "最も利用した駅",
};
