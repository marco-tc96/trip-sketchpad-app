const translations: Record<string, string> = {
  ...
  add_packing_item: "Gegenstand hinzufügen…",
  packing_list_empty: "Noch keine Gegenstände.",
  ...
  light_mode: "Hell",
  dark_mode: "Dunkel",
  dock_style: "Dock-Stil",
  dock_style_default: "Standard",
  dock_style_liquid: "Liquid Glass",
  ...
  days_to_end: "Endet in {{n}} Tagen",
  day_to_end: "Endet in {{n}} Tag",
  ...
  boarding_stop: "Einstiegshaltestelle",
  alighting_stop: "Ausstiegshaltestelle",
  vehicle_name: "Fahrzeug (z.B. Bus 220)",
  add_leg: "Abschnitt hinzufügen",
  legs_label: "Abschnitte",
  multi_modal: "multimodal",
  line: "Linie",
  select_line: "Linie wählen…",
  toll_booth_placeholder: "Mautstelle suchen…",
  train_scope_national: "National",
  train_scope_local: "Lokal",
  ...
  next_trip: "Nächste Reise",
  no_upcoming_trips: "Keine Reise geplant",
  days_traveled: "Reisetage",
  stats_year: "Statistik {{year}}",
  // ── Farthest-points compass (Profile page) ─────────────────────────────
  extremes_title: "Extrempunkte",
  northernmost: "Am nördlichsten",
