const translations: Record<string, string> = {
  ...
  dark_mode: "深色",
  dock_style: "Dock 样式",
  dock_style_default: "标准",
  dock_style_liquid: "液态玻璃",
  layover: "经停",
  layovers: "经停",
  direct: "直达",
  ...
  transport_stats: "交通统计",
  most_used_line: "最常用线路",
  most_used_route: "最常用路线",
  most_used_station: "最常用车站",
};
